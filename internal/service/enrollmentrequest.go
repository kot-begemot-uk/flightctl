...
func approveEnrollmentRequest(ca *crypto.CA, enrollmentRequest *v1alpha1.EnrollmentRequest, approval *v1alpha1.EnrollmentRequestApproval) error {
...
func (h *ServiceHandler) ApproveEnrollmentRequest(ctx context.Context, request server.ApproveEnrollmentRequestRequestObject) (server.ApproveEnrollmentRequestResponseObject, error) {
	...
	if request.Body.Approved {
		...
		if err := approveEnrollmentRequest(h.ca, enrollmentReq, request.Body); err != nil {
